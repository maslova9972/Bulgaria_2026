...
const schedule = [
  ['10:30', 'Welcome и бизнес-завтрак', 'Знакомство участников, лёгкий формат общения и первые деловые контакты.'],
...
const wheelPrizes = [
  ...
  'VIP-знакомство с участником по вашему запросу',
  'Разбор вашей самопрезентации',
  'Персональный подарок участника',
]
...
const faqQuestions = [
  [
    ...
    'Участие в тренинге, бизнес-завтрак, международная нетворкинг-сессия, рабочие материалы, чай, кофе и вода, а также персональный подарок каждому участнику.',
  ],
  [
  ...
  [
    ...
    'Оставьте короткую заявку в конце страницы. Наталья свяжется с вами, пришлёт детали встречи и условия оплаты.',
  ],
]
  ...
  return (
    <section className="hero" id="top" aria-labelledby="hero-title">
      ...
      <h1 className="hero-title" id="hero-title">
        <span>Business</span>
        <span className="hero-title__accent">Breakfast</span>
        <span>Bulgaria</span>
      </h1>
  ...
  return (
    <section className="program section-dark" id="program">
      <div className="program-intro">
        ...
        <h3>Бизнес-завтрак 6 сентября 2026, Солнечный берег</h3>
        <p className="program-statline">Тренинг. Завтрак. Международный нетворкинг.</p>
        <p>
          Камерный формат: столько участников, чтобы каждый успел познакомиться с каждым и уйти с
          договорённостями, а не с пачкой визиток.
        </p>
      </div>
    ...
    <section className="speaker-solo section-dark" id="speaker" aria-labelledby="speaker-title">
      ...
      <div className="speaker-solo__copy">
        ...
        <p className="speaker-solo__role">
          Бизнес-тренер, бренд-маркетолог, PhD и MBA. Эксперт по системным продажам, сообществам и нетворкингу.
        </p>
        ...
        <blockquote className="speaker-solo__quote">
          Я не буду учить вас подходить к незнакомым людям. Мы разберём, как сделать так, чтобы один правильный
    ...
    <section className="breakfast-pricing section-dark" id="price" aria-labelledby="price-title">
      <div className="breakfast-pricing__copy">
        ...
        <a className="text-link" href={organizerTelegramUrl} target="_blank" rel="noreferrer">
          Задать вопрос Наталье <ArrowIcon />
        </a>
      </div>

      <article className="breakfast-pass">
        <span className="breakfast-pass__date">6 сентября 2026 · Солнечный берег</span>
  ...
  return (
    <section className="contact" id="contact" aria-labelledby="contact-title">
      <div className="contact-copy">
        ...
        <p>
          Оставьте контакт, и Наталья Маслова подтвердит место на бизнес-завтраке 6 сентября, пришлёт детали
          встречи и ответит на вопросы лично.
        </p>
        {partner && (
